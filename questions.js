...
const QUESTIONS = [
  ...
  [
    ...
    },
    {
      ...
      fallbackChoices: ["Magnetism", "Gravity", "Centrifugal force", "Dark energy"],
      fallbackAnswer: 1,
  ...
  [
    {
      ...
      choices: ["Telescope", "Spectrograph", "Barometer", "Magnetometer"],
      answer: 1,
  ...
  [
    ...
    },
    {
      ...
      fallbackChoices: ["Tides", "Seasons", "Day/night cycles", "Magnetic reversals"],
      fallbackAnswer: 1,
  ...
  [
    ...
    },
    {
      ...
      choices: ["Fuel weight", "Cosmic & solar radiation exposure", "Signal delay", "Food storage"],
      answer: 1,
  ...
  [
    ...
    },
    {
      ...
      choices: ["A moon's orbit circularizes", "Tidal forces disintegrate a satellite", "Atmosphere begins", "Light can't escape"],
      answer: 1,
  ...
  [
    ...
    },
    {
      ...
      fallbackChoices: ["1:1", "1:2", "2:3", "3:5"],
      fallbackAnswer: 1,
  ...
  [
    ...
    },
    {
      ...
      choices: ["They're colder", "Interiors dominated by water/ammonia/methane ices", "They have solid surfaces", "No magnetic fields"],
      answer: 1,
    ...
    },
    {
      ...
      fallbackChoices: ["Oxygen", "Methane", "Nitrogen", "Carbon dioxide"],
      fallbackAnswer: 1,
  ...
  [
    {
      ...
      choices: ["Planets form rings", "Liquid water can exist on a surface", "Magnetic fields are strongest", "Solar wind is weakest"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Age of universe", "Communicative civilizations in our galaxy", "Mass of dark matter", "Distance to nearest exoplanet"],
      answer: 1,
    ...
    },
    {
      ...
      choices: ["Radial velocity", "Transit photometry", "Direct imaging", "Gravitational microlensing"],
      answer: 1,
  ...
  [
    ...
    },
    {
      ...
      choices: ["No — sunlight is required", "Yes — chemosynthetic life near vents", "No — liquid water needs a star", "Yes — but only plants"],
      answer: 1,
